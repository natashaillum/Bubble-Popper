...
playerLeft.src = './Images/red-swim.png';
const playerRight= new Image();
playerRight.src = './Images/red-swim-right.png';
class Player{
    constructor(){
        this.x = canvas.width;
...
enemyImage.src = './Images/yellow-swim.png';
...
class Enemy{
    ...
    draw(){
        ...
        // ctx.fill();
        ctx.drawImage(enemyImage, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.x -20, this.y -20, this.spriteWidth/5 , this.spriteHeight/8);
    }
    update(){
        this.x -= this.speed;
        ...
        if (distance < this.radius - 20 + player.radius -40){
            handleGameOver();
        }
    }
}
...
function handleGameOver(){
    ctx.fillStyle = 'white';
    ctx.fillText ('GAME OVER , You reached score ' + score, 60, 250);
    gameOver = true;
}
